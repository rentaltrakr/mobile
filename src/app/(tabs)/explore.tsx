    ...
    >
      ...
      <Collapsible title={t("explore_platforms_title")}>
        <ThemedText>
          ...
          {t("explore_platforms_desc2")}
        </ThemedText>
      </Collapsible>
      <Collapsible title={t("explore_images_title")}>
        <ThemedText>
          {t("explore_images_desc1")}
          <ThemedText type="defaultSemiBold">@2x</ThemedText>
          {t("explore_and")} <ThemedText type="defaultSemiBold">@3x</ThemedText>
